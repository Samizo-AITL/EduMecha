...
| 📂 ディレクトリ / Directory | 📘 内容 / Description | 🔗 リンク / Links |
|-----------------------------|------------------------|-------------------|
...
| 💧 **Inkjet** | インクジェット技術アーキテクチャ教材<br>Inkjet Technology Architecture | [![🌐 View Site](https://img.shields.io/badge/View%20Site-Inkjet-brightgreen?logo=github)](https://samizo-aitl.github.io/Inkjet/)<br>[![💻 View Repo](https://img.shields.io/badge/View%20Repo-Inkjet-blue?logo=github)](https://github.com/Samizo-AITL/Inkjet) |
